...
class RetryingCall(object):
    ...
    def _err(self, fail):
        ...
        try:
            ...
            if isinstance(fail, failure.Failure):
                ...
                print 'RetryingCall: Ignoring %r' % (fail,)
                self._call()
    ...
    def _call(self):
        try:
            ...
            print 'StopIteration in RetryingCall: ran out of attempts.'
...
def simpleBackoffIterator(maxResults=10, maxDelay=120.0, now=True, initDelay=0.01, incFunc=None):
    assert maxResults > 0
